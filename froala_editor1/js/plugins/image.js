...
!function(a) {
    ...
    a.FE.PLUGINS.image = function(b) {
        ...
        function g(a) {
            a.hasClass("fr-dii") || a.hasClass("fr-dib") || (a.addClass("fr-fi" + ma(a)[0]),
            a.addClass("fr-di" + na(a)[0]),
            a.css("margin", ""),
            a.css("float", ""),
            a.css("display", ""),
            a.css("z-index", ""),
        ...
        function j() {
            ...
            if (Ka)
                for (c = 0; c < Ka.length; c++)
                    e.indexOf(Ka[c].getAttribute("src")) < 0 && b.events.trigger("image.removed", [a(Ka[c])]);
            Ka = d
        }
        function k() {
            ya || Z();
        ...
        function n(c) {
            ...
            if (za && xa) {
                ...
                if ((za.hasClass("fr-hnw") || za.hasClass("fr-hsw")) && (g = 0 - g),
                b.opts.imageResizeWithPercent) {
                    ...
                    h + g >= b.opts.imageMinWidth && xa.css("width", h + g),
        ...
        function q(a) {
            if (a)
                return b.$wp && b.events.$on(b.$wp, "scroll", function() {
                    xa && b.popups.isVisible("image.edit") && (b.events.disableBlur(),
                    w(xa))
                }),
                !0;
            var c = "";
        ...
        function E(c, d, e) {
            ...
            return j.parent().is("hr") && j.parent().after(j),
        ...
        function G(c, d, e, f) {
            ...
            i.addEventListener("load", function() {
                ...
                if (i.result.indexOf("svg+xml") < 0) {
                    for (var c = atob(i.result.split(",")[1]), d = [], e = 0; e < c.length; e++)
        ...
        function H(a, c) {
            ...
            if ("undefined" != typeof a && a.length > 0) {
                if (b.events.trigger("image.beforeUpload", [a]) === !1)
                    return !1;
                var d = a[0];
                if (d.size > b.opts.imageMaxSize)
                    return p(Ga),
                    !1;
                if (b.opts.imageAllowedTypes.indexOf(d.type.replace(/image\//g, "")) < 0)
                    return p(Ha),
                    !1;
                var e;
                ...
                e) {
                    ...
                    if (b.opts.imageUploadToS3 !== !1) {
                        ...
                        for (f in b.opts.imageUploadToS3.params)
                            b.opts.imageUploadToS3.params.hasOwnProperty(f) && e.append(f, b.opts.imageUploadToS3.params[f])
                    }
                    for (f in b.opts.imageUploadParams)
                        b.opts.imageUploadParams.hasOwnProperty(f) && e.append(f, b.opts.imageUploadParams[f]);
        ...
        function J(c) {
            ...
            if (d && d.files && d.files.length) {
                ...
                if (e && e.type && e.type.indexOf("image") !== -1) {
                    ...
                    r(),
                    b.opts.imageAllowedTypes.indexOf(e.type.replace(/image\//g, "")) >= 0 ? H(d.files) : p(Ha),
                    c.preventDefault(),
                    c.stopPropagation(),
                    !1
                }
        ...
        function K() {
            ...
            d && b.html.defaultTag() ? d.nextSibling || (["TD", "TH"].indexOf(d.tagName) < 0 ? a(d).after("<" + b.html.defaultTag() + "><br>" + a.FE.MARKERS + "</" + b.html.defaultTag() + ">") : a(c).after("<br>" + a.FE.MARKERS),
            ...
            c && "IMG" == c.tagName && "block" == a(c).css("display") && (d = b.node.blockParent(c),
            d && b.html.defaultTag() ? d.previousSibling || (["TD", "TH"].indexOf(d.tagName) < 0 ? a(d).before("<" + b.html.defaultTag() + "><br>" + a.FE.MARKERS + "</" + b.html.defaultTag() + ">") : a(c).before("<br>" + a.FE.MARKERS),
        ...
        function L() {
            b.events.$on(b.$el, b._mousedown, "IMG" == b.el.tagName ? null : 'img:not([contenteditable="false"])', function(c) {
                return "false" == a(this).parents("[contenteditable]:not(.fr-element):not(body):first").attr("contenteditable") || (b.helpers.isMobile() || b.selection.clear(),
                Ba = !0,
                b.popups.areVisible() && b.events.disableBlur(),
            ...
            b.events.$on(b.$el, b._mouseup, "IMG" == b.el.tagName ? null : 'img:not([contenteditable="false"])', function(c) {
                return "false" == a(this).parents("[contenteditable]:not(.fr-element):not(body):first").attr("contenteditable") || void (Ba && (Ba = !1,
                c.stopPropagation(),
        ...
        function P(a) {
            if (a)
                return b.popups.onRefresh("image.alt", N),
                !0;
            var c = "";
        ...
        function T(a) {
            if (a)
                return b.popups.onRefresh("image.size", R),
                !0;
            var c = "";
        ...
        function U(a, c) {
            if (xa) {
                ...
                var e = /^[\d]+((px)|%)*$/g;
                a.match(e) && xa.css("width", a),
                c.match(e) && xa.css("height", c),
        ...
        function V(a) {
            ...
            !xa && b.opts.toolbarInline && (d = e.offset().top - b.helpers.getPX(e.css("margin-top")),
        ...
        function Z() {
            var c;
            if (b.shared.$image_resizer ? (ya = b.shared.$image_resizer,
            Aa = b.shared.$img_overlay,
            ...
            b.opts.imageResize) {
                ...
                b.events.on("keydown", function(c) {
                    if (xa) {
                        ...
                        (h == a.FE.KEYCODE.EQUALS || b.browser.mozilla && h == a.FE.KEYCODE.FF_EQUALS) && g && !c.altKey ? d = Y.call(this, c, 1, 1, d) : (h == a.FE.KEYCODE.HYPHEN || b.browser.mozilla && h == a.FE.KEYCODE.FF_HYPHEN) && g && !c.altKey ? d = Y.call(this, c, 2, -1, d) : b.keys.ctrlKey(c) || h != a.FE.KEYCODE.ENTER || (xa.before("<br>"),
                        w(xa)),
                        e = h,
                        f = c.timeStamp
                    }
        ...
        function _(c) {
            ...
            return xa && d != a.FE.KEYCODE.F10 && !b.keys.isBrowserAction(c) ? (c.preventDefault(),
            c.stopPropagation(),
            !1) : void 0
        }
        function aa(a) {
            if (a && "IMG" == a.tagName)
                ...
                for (var c = a.querySelectorAll("img.fr-uploading, img.fr-error, img.fr-draggable"), d = 0; d < c.length; d++)
                    aa(c[d])
        }
        function ba() {
            if (L(),
            "IMG" == b.el.tagName && b.$el.addClass("fr-view"),
            b.events.$on(b.$el, b.helpers.isMobile() && !b.helpers.isWindowsPhone() ? "touchend" : "click", "IMG" == b.el.tagName ? null : 'img:not([contenteditable="false"])', fa),
            b.helpers.isMobile() && (b.events.$on(b.$el, "touchstart", "IMG" == b.el.tagName ? null : 'img:not([contenteditable="false"])', function() {
                La = !1
            }),
            ...
            b.events.on("window.cut window.copy", function(a) {
                xa && b.popups.isVisible("image.edit") && !b.popups.get("image.edit").find(":focus").length && (ta(),
                b.paste.saveCopiedText(xa.get(0).outerHTML, "\n"),
            ...
            b.events.on("paste.before", da),
            b.events.on("paste.beforeCleanup", ea),
            b.events.on("paste.after", ca),
        ...
        function ca() {
            b.opts.imagePaste ? b.$el.find("img[data-fr-image-pasted]").each(function(c, d) {
                ...
                if (0 === d.src.indexOf("data:")) {
                    ...
                    0 !== d.src.indexOf("http") || 0 === d.src.indexOf("https://mail.google.com/mail") ? (b.selection.save(),
                    a(d).remove(),
        ...
        function fa(c) {
            if ("false" == a(this).parents("[contenteditable]:not(.fr-element):not(body):first").attr("contenteditable"))
                return !0;
        ...
        function ka(a, c, d) {
            ...
            a.addClass("fr-fi" + d[0] + " fr-di" + c[0])) : "inline" == c ? (a.css({
        ...
        function ua() {
            xa ? (b.events.disableBlur(),
            a(".fr-popup input:focus").blur(),
            w(xa)) : (b.events.disableBlur(),
            b.selection.restore(),
            b.events.enableBlur(),
            b.popups.hide("image.insert"),
        ...
        function wa(a, c, d) {
            ...
            "object" == typeof c[a] ? (xa.removeAttr("style"),
            xa.css(c[a].style)) : xa.toggleClass(a),
            w(xa)
        }
    ...
    a.FE.RegisterCommand("imageAlign", {
        ...
        html: function() {
            ...
            for (var d in c)
                c.hasOwnProperty(d) && (b += '<li role="presentation"><a class="fr-command fr-title" tabIndex="-1" role="option" data-cmd="imageAlign" data-param1="' + d + '" title="' + this.language.translate(c[d]) + '">' + this.icon.create("image-align-" + d) + '<span class="fr-sr-only">' + this.language.translate(c[d]) + "</span></a></li>");
            return b += "</ul>"
        },
        callback: function(a, b) {
            this.image.align(b)
